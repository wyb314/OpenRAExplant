...
namespace Engine.ComponentAnim.Core
{
    ...
    public class AnimAttackData
    {
        ...
        public AnimAttackData(string animName,float moveDistance, float hitTime, 
            float moveStartTime, float moveEndTime, float attackEndTime, float hitDamage, 
            float hitAngle, float hitMomentum,
                    E_CriticalHitType criticalType, float criticalMod, bool areaKnockDown,

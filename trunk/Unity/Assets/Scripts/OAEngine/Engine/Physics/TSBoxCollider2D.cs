    ...
    public class TSBoxCollider2D : TSCollider2D
    {
        ...
        public TSVector2 size
        {
            get
            {
                if (_body != null)
                {
                    TSVector2 halfVector = ((PolygonShape)_body.FixtureList[0].Shape).Vertices[0] * 2;
            ...
            set
            {
                ...
                if (_body != null)
                {
                    ...
                    ((PolygonShape)_body.FixtureList[0].Shape).Vertices = TrueSync.Physics2D.PolygonTools.CreateRectangle(sizeScaled.x * FP.Half, sizeScaled.y * FP.Half);
                }

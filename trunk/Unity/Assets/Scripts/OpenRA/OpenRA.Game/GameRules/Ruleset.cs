    ...
    public class Ruleset
    {
        ...
        public static Ruleset LoadDefaults(ModData modData)
        {
            ...
            if (modData.IsOnMainThread)
            {
                ...
                var loader = new Thread(new ThreadStart(f));
                loader.Start();
        ...
        public static Ruleset LoadDefaultsForTileSet(ModData modData, string tileSet)
        {
            ...
            return new Ruleset(dr.Actors, dr.Weapons, dr.Voices, dr.Notifications, dr.Music, ts, dr.ModelSequences);
            ...
            MiniYaml mapMusic, MiniYaml mapSequences, MiniYaml mapModelSequences)
        {
            ...
            Action f = () =>
            {
                ...
                ruleset = new Ruleset(actors, weapons, voices, notifications, music, ts, modelSequences);

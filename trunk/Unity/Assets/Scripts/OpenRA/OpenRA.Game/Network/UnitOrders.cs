                ...
                case "Chat":
                    {
                        ...
                        if (client != null)
                        {
                            ...
                            Game.AddChatLine(Color.white, client.Name + suffix, order.TargetString);
                        }
                        else
                        ...
                        if (client != null)
                        {
                            if (world == null)
                            {
                                if (orderManager.LocalClient != null && client.Team == orderManager.LocalClient.Team)
                                    Game.AddChatLine(Color.white, "[Team] " + client.Name, order.TargetString);
                            }
                            else
                            {
                                var player = world.FindPlayerByClient(client);
                                if (player != null && player.WinState == WinState.Lost)
                                    Game.AddChatLine(Color.white, client.Name + " (Dead)", order.TargetString);
                                else if ((player != null && world.LocalPlayer != null && player.Stances[world.LocalPlayer] == Stance.Ally) || (world.IsReplay && player != null))
                                    Game.AddChatLine(Color.white, "[Team" + (world.IsReplay ? " " + client.Team : "") + "] " + client.Name, order.TargetString);
                                    ...
                                    Game.AddChatLine(Color.white, "[Spectators] " + client.Name, order.TargetString);
                            }
                        }
